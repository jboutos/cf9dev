...
public class Account {
     ...
     * @throws Exception if the amount is negative, insiffucient or the ssn does not match
     */
    public void withdraw(double amount, String ssn) throws Exception {
        try {
            if (amount <= 0) throw new Exception("The amount should be positive.");
            if (amount > balance) throw new Exception("The amount withdrawn cannot be greater than the balance.");
